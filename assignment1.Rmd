...
There are 19422 ensemble ids, only 19332 are mapped to current HUGO symbols, this is not too surprising as the associated publication was published on January 28, 2021, and the dataset was last updated on GEO on February 17, 2021.
and it is February 15, 2022 at the time of writing this report, so the dataset was not too outdated.
